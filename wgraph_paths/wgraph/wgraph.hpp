...
public:
  ...
  /** @{*/
    ...
    /**
     * @brief Makes a Weighted Graph with capacity nodes.
     * @param capacity is the maximum number of vertices.
     * @param default_weight used to initialize edges' weight.
     * @pre capacity > 0
     * @post is_empty()
     ...
     * @param input is the input stream.capacity maximum number of vertices.
     * @return a reference to the created graph.
     */
  ...
  /**@{*/
    ...
    */
    ...
    /**
    * @brief Are nodes u and v adjacent?
    * A vertex u is adjacent to v if the weight of the edge u->v is less than inf.
    * @arg[in] u ,
    * @arg[in] v are nodes.
  ...
  /** @{*/
    ...
    /** @{*/
        /**
         * @brief set the visited state for all the nodes.
         */
        ...
        */
        ...
        /**
        * @brief Move the node and graph cursors.
        * @arg[in] e is the edge where moving cursors.
